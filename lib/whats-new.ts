...
export const WHATS_NEW: WhatsNew[] = [
  ...
  },
  {
    ...
    blurb:
      "Water is a sixth macro now \u2014 same meter as calories and protein, on Eat and on Progress. Add it where you add food: a glass, a bottle, or type it. Your coach can log it too, and a day you didn\u2019t log is never counted as a day you didn\u2019t drink.",
    href: "/eat",
  },
  {
  ...
  },
  {
    ...
    date: "2026-09-18",
    title: "Sore Winner",
    blurb: "The app has a name and an address: sorewinner.app. Sore is the win. Your old link still works.",
  },
  {
    id: "2026-09-18-kitchen",
    date: "2026-09-18",
    title: "The Kitchen, rebuilt",
    blurb: "One list, two views. To buy is the week's meals added up by aisle, each line saying how many meals want it and what you already have; In the kitchen is what you've got. Share the list, or send it to Instacart once that's connected.",
    href: "/kitchen",
  },
  {
    id: "2026-09-18-coach-name",
    date: "2026-09-18",
    title: "Name your coach",
    blurb: "Call your coach whatever you like — it answers to it in the chat and on every button. Settings → Your coach.",
    href: "/settings",
  },
  {
    id: "2026-09-18-arrange",
    date: "2026-09-18",
    title: "Arrange Train and Eat",
    blurb: "Every card on Train and Eat has a grip on its top edge: move it up or down, or hide it. Or just ask — “put the calculator at the top”.",
    href: "/train",
  },
  {
    id: "2026-09-18-sides",
    date: "2026-09-18",
    title: "Left and right, if you want it",
    blurb: "One-sided movements can ask which side each set was, opening on the side you didn't do last. Off unless you turn it on in Settings → Training.",
    href: "/settings",
  },
  {
    id: "2026-09-18-week",
    ...
    blurb: "Progress now shows each movement's volume against the week before as a row of numbers, biggest change first, instead of two lists of sentences.",
    href: "/progress",
  },
  {
    id: "2026-09-18-forgot",
    date: "2026-09-18",
    title: "Forgot your password?",
    blurb: "There's a link for it under sign-in now. It emails you a one-hour link to choose a new one, and signs every other device out.",
  },
  {
    id: "2026-09-05-holds",
    date: "2026-09-05",
