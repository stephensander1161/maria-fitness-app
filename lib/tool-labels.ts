...
export const TOOL_LABELS: Record<string, string> = {
  ...
  pause_workout: "pausing your session", set_session_time: "correcting the session clock",
  resume_workout: "starting the clock again",
  ...
  fill_macro_gaps: "filling in the missing macros",
  ...
  set_exercise_target: "changing the target",
  ...
  arrange_cards: "moving that card",
};
