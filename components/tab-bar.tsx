...
// Train, Eat, Progress, Plan: the order she reaches for them. Plan was third
// and read as a daily screen; it is not — "once my plan is set I don't
// change it much" — where Progress is looked at most days.
export const TABS = [
